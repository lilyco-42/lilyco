    ...
    fn what_a_cell_looks_like_is_one_hop_away() {
        ...
        assert_eq!(
            ...
            json!({
                "attrs": {},
                "parts": [
                    {"element": "name", "attrs": {"val": "微软雅黑"}},
                    {"element": "b", "attrs": {"val": "1"}},
                    {"element": "color", "attrs": {"rgb": "FFC00000"}},
                    {"element": "sz", "attrs": {"val": "12"}},
                ],
            }),
            "格式住在 font 行的孩子上：{}",
            cells[0]["style_font"]
